...
def attack(char_name: str, char_class: str) -> str:
    """Рандомно выдаст количество нанесенного урона."""
...
def defence(char_name: str, char_class: str) -> str:
    """Рандомно выдаст количество заблокированного урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Сообщит о применении специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Тренировка игрока, вызов функций тренировки."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбор персонажа, выдаст его характеристики."""
    approve_choice: str = ''
    char_class: str = ''
